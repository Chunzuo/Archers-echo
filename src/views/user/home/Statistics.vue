...
export default {
  ...
  methods: {
    async getServicesServerCount() {
      ...
      this.servicesServerCount = await api.getServicesServerCount(this.userId);
    ...
    async getDatabaseCount() {
      ...
      this.databaseCount = await api.getDatabaseCount(this.userId);
    ...
    async getArcherCount() {
      ...
      this.archerCount = await api.getArcherCount(this.userId);
    ...
    async getWebserverCount() {
      ...
      this.webServerCount = await api.getWebServerCount(this.userId);
